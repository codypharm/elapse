...
Status: **Built · FR-LND-014–019 signed and built 2026-09-08** · Surface: Persuade · Sources: design brief Surface 1; detailed doc §1, §5.3, §16.
...
| FR-LND-014 | **Hero for both readers.** Headline stays `You only pay what elapsed.` The subline speaks for the merchant: earns per second of use, paid out in dollars as it accrues, integrated like Stripe (SDK, hosted checkout, signed webhooks). Buttons: primary `Start integrating` → docs quickstart; secondary `See the demo` → scrolls to the merchant section (FR-LND-016) until the video exists, then the video. | Built |
