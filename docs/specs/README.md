...
| `dashboard-frd.md` | **Signed** · built against the mock API (all FR-DSH except the subscriber `/account` which lives in the checkout spec) · FR-DSH-114–118 forms hardening **signed and built 2026-09-07** · FR-DSH-005 search as you type **signed and built 2026-09-09** · FR-DSH-126 lists page with Load more **signed and built 2026-09-09** | William, 2026-09-03 |
